...
const translations = {
    vi: {
        ...
        menuEditUploadImage: 'Đăng ảnh lên',
        menuEditUploadImageDesc: 'Mở cửa sổ để tải lên và nhúng hình ảnh',
        menuEditResetAll: 'Reset toàn bộ nội dung',
        menuEditResetAllDesc: 'Xóa dữ liệu lưu cục bộ và tải lại',
        menuToolsTheme: 'Đổi Giao diện Tối/Sáng',
        menuToolsThemeDesc: 'Bật hoặc tắt chế độ tối',
        menuToolsZenMode: 'Chế độ Tập trung',
        menuToolsZenModeDesc: 'Ẩn các thanh công cụ để tập trung viết',
        ...
        appScriptUrl: 'URL App Script',
        appScriptUrlLabel: 'URL App Script (để upload)',
        appScriptUrlHint: 'URL web app script để cho phép push trực tiếp vào file excel',
        appScriptUrlPlaceholder: 'Nhập web app url',
        pushVersion: 'Đẩy (Push) version lên Sheet',
        appScriptUrlMissing: 'Vui lòng thiết lập App Script URL trong Cài đặt.',
        pushSuccess: 'Đã đẩy lên Sheet thành công!',
        pushFailed: 'Lỗi khi đẩy lên Sheet',
        pushing: 'Đang đẩy lên...',
        confirmPushTitle: 'Push Version',
        confirmPushMessage: 'Đẩy phiên bản này lên Google Sheet?',
        pushOverwrite: 'Ghi đè version hiện tại',
        pushNewColumn: 'Tạo cột mới',
        pushNewColumnName: 'Tên cột mới (VD: Ver2)',
        uploadImageTitle: 'Đăng ảnh lên',
        uploadProtocolLabel: 'Protocol',
        uploadImageSelectProtocol: 'Chọn protocol',
        uploadImageUrlLabel: 'URL Ảnh',
        uploadImageUrlPlaceholder: 'Nhập URL ảnh (https://...)',
        uploadImageConditionLabel: 'Biến liên kết ảnh (Tuỳ chọn)',
        uploadImageSelectVar: 'Chọn biến',
        uploadImageSelectValue: 'Chọn giá trị',
        uploadImageValuePlaceholder: 'Giá trị...',
        uploadImageAddVar: 'Thêm biến',
        uploadImageDescLabel: 'Mô tả ảnh',
        uploadImageDescPlaceholder: 'Nhập mô tả ảnh...',
        uploadImageErrorMsg: 'Không thể tải ảnh từ URL này.',
        uploadImagePreview: 'Bản xem trước ảnh',
        uploadImageCancelBtn: 'Hủy',
        uploadImageBtn: 'Đăng ảnh',
        uploadImageUploading: 'Đang tải lên...',
        uploadImageSuccessToast: 'Đăng ảnh thành công!',
        uploadImageErrorToast: 'Lỗi đăng ảnh'
    },
    en: {
        ...
        menuEditUploadImage: 'Upload Image',
        menuEditUploadImageDesc: 'Open dialog to upload and embed images',
        menuEditResetAll: 'Hard reset all content',
        menuEditResetAllDesc: 'Clear local data and reload',
        menuToolsTheme: 'Toggle Dark/Light Theme',
        menuToolsThemeDesc: 'Enable or disable dark mode',
        menuToolsZenMode: 'Zen Mode',
        menuToolsZenModeDesc: 'Hide sidebars to focus on writing',
        ...
        appScriptUrl: 'App Script URL',
        appScriptUrlLabel: 'App Script URL (for upload)',
        appScriptUrlHint: 'Web app script URL to enable pushing directly to excel file',
        appScriptUrlPlaceholder: 'Enter web app url',
        pushVersion: 'Push version to Sheet',
        appScriptUrlMissing: 'Please configure App Script URL in Settings.',
        pushSuccess: 'Successfully pushed to Sheet!',
        pushFailed: 'Failed to push to Sheet',
        pushing: 'Pushing...',
        confirmPushTitle: 'Push Version',
        confirmPushMessage: 'Push this version to Google Sheet?',
        pushOverwrite: 'Overwrite current version',
        pushNewColumn: 'Create new column',
        pushNewColumnName: 'New column name (e.g. Ver2)',
        uploadImageTitle: 'Upload Image',
        uploadProtocolLabel: 'Protocol',
        uploadImageSelectProtocol: 'Select protocol',
        uploadImageUrlLabel: 'Image URL',
        uploadImageUrlPlaceholder: 'Enter image URL (https://...)',
        uploadImageConditionLabel: 'Image link condition (Optional)',
        uploadImageSelectVar: 'Select variable',
        uploadImageSelectValue: 'Select value',
        uploadImageValuePlaceholder: 'Value...',
        uploadImageAddVar: 'Add variable',
        uploadImageDescLabel: 'Image description',
        uploadImageDescPlaceholder: 'Enter image description...',
        uploadImageErrorMsg: 'Cannot load image from this URL.',
        uploadImagePreview: 'Image preview',
        uploadImageCancelBtn: 'Cancel',
        uploadImageBtn: 'Upload',
        uploadImageUploading: 'Uploading...',
        uploadImageSuccessToast: 'Image uploaded successfully!',
        uploadImageErrorToast: 'Upload error'
    }
};
